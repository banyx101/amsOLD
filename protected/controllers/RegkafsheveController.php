...
class RegkafsheveController extends Controller
{
	/**
...
//qe ketu percaktohet llogjika e ngarkimit te AR me ID e Personit
	...
	public function actionCreate()
	{
		...
		$model->Anetaret_idAnetare = $this->_personID->idPersona;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Regkafsheve']))
		{
			$model->attributes=$_POST['Regkafsheve'];
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->idKafshet));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Regkafsheve');
	...
	{
		$model=new Regkafsheve('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Regkafsheve']))
			$model->attributes=$_GET['Regkafsheve'];
	...
	{
		$model=Regkafsheve::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='regkafsheve-form')
		{
