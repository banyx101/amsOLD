...
class AnetaretController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Anetaret']))
		{
			$model->attributes=$_POST['Anetaret'];
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->Persona_idPersona));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Anetaret');
	...
	{
		$model=new Anetaret('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Anetaret']))
			$model->attributes=$_GET['Anetaret'];
	...
	{
		$model=Anetaret::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='anetaret-form')
		{
